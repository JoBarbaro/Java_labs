...
// Добавить соответствующий элемент меню
        ...
        Action showAxisAction = new AbstractAction("Показывать оси координат") {
            public void actionPerformed(ActionEvent event) {
// свойство showAxis класса lab4.GraphicsDisplay истина, если элемент меню
...
// Элемент по умолчанию включен (отмечен флажком)
        ...
        // Маркер особых точек
        Action showMarkers = new AbstractAction("Показывать маркеры особых точек") {
            public void actionPerformed(ActionEvent event) {
...
// Установить lab4.GraphicsDisplay в цент граничной компоновки
