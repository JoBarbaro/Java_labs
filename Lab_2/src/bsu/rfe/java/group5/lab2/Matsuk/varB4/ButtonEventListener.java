    ...
    public void actionPerformed(ActionEvent e) {
        try {
            if (e.getSource() == this.this$0.getButtonCalculate()) {
                ...
                if (x < 0 || (x * z < 0)) {
                    JOptionPane.showMessageDialog(this.this$0, "Ïîïûòêà âû÷èñëåíèå êîðíÿ èç îòðèöàòåëüíîãî çíà÷åíèÿ", "Íåâîçìîæíî ïîñ÷èòàòü çíà÷åíèå ôóíêöèè", 2);

                } else if (x == 0 || y == 0) {
                    JOptionPane.showMessageDialog(this.this$0, "Ïîïûòêà äåëåíèÿ íà 0", "Íåâîçìîæíî ïîñ÷èòàòü çíà÷åíèå ôóíêöèè", 2);
                } else {
            ...
            JOptionPane.showMessageDialog(this.this$0, "Îøèáêà â ôîðìàòå çàïèñè ÷èñëà ñ ïëàâàþùåé òî÷êîé", "Îøèáî÷íûé ôîðìàò ÷èñëà", 2);
        }
